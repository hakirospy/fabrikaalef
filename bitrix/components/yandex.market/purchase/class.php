...
class Purchase extends \CBitrixComponent
{
	...
	protected function getSetup()
	{
		...
		$result = $this->loadSetup($serviceCode, $siteId);
	...
	protected function loadSetup($serviceCode, $siteId)
	{
		try
		{
		...
		catch (Main\ObjectNotFoundException $exception)
		{
			...
			$result = Market\Trading\Setup\Model::loadByServiceAndSite($useCode, $siteId);
		}

<?
$MESS["ARTURGOLUBEV_EC_DEMO_IS_EXPIRED"] = "Демонстрационный период работы решения закончился. Для дальнейшего использования необходимо приобрести полую версию решения в <a href=\"http://marketplace.1c-bitrix.ru/solutions/arturgolubev.ecommerce/\" target=\"_blank\">marketplace.1c-bitrix.ru</a>";
...
$MESS["ARTURGOLUBEV_EC_OFF_MODE"] = "Отключить работу модуля для всех сайтов:";
...
$MESS["ARTURGOLUBEV_EC_REQUEST_MODE"] = "<span data-hint=\"Определяет как решение производит сбор событий. Запрос с интервалом - старый стабильный метод. Режим работы по событиям - новый, более производительный и потенциально точный режим - пока работает в бета режиме.\"></span> Режим работы:";
$MESS["ARTURGOLUBEV_EC_REQUEST_MODE_NOTE"] = "В последней версии решения был добавлен новый режим работы \"По событиям\". Это экспериментальный режим, он уменьшает нагрузку от работы решения, но пока находится на этапе беты. Если он покажет такую же надежность как и интервальный режим он войдет в продукт на постоянной основе.";
$MESS["ARTURGOLUBEV_EC_REQUEST_MODE_INTERVALS"] = "Запрос с интервалом";
$MESS["ARTURGOLUBEV_EC_REQUEST_MODE_EVENTS"] = "Работа по событиям (beta)";

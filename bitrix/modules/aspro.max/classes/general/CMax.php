...
class CMax{
	...
	public static function getStoriesSections($arParams) {
		...
		$arSections = CMaxCache::CIBLockSection_GetList(array($arParams['SORT_DATA']['SORT'] => $arParams['SORT_DATA']['SORT_ORDER'], $arParams['SORT_DATA']['SORT_2'] => $arParams['SORT_DATA']['SORT_ORDER_2'],  'CACHE' => array('MULTI'=> 'N', "GROUP" => 'ID', 'TAG' => CMaxCache::GetIBlockCacheTag($iblockID))), $arSectionsFilter, true, $arSectionsSelect);

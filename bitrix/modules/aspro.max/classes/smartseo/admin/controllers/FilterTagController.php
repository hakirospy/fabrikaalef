...
class FilterTagController extends Controller
{
    ...
    public function actionGetMenuTagProperty()
    {
        ...
        if($filterCondition['CONDITION_TREE']) {
            $conditionTreeResult = new \Aspro\Max\Smartseo\Condition\ConditionResultHandler($iblockId, $filterCondition['CONDITION_TREE']);
    ...
    private function getListIdenticalProperty($iblockId, $parentFilterConditionId, $filterConditionId)
    {
        ...
        $parentConditionTreeResult = new \Aspro\Max\Smartseo\Condition\ConditionResultHandler($iblockId, $filterConditions[$parentFilterConditionId]);
        $conditionTreeResult = new \Aspro\Max\Smartseo\Condition\ConditionResultHandler($iblockId, $filterConditions[$filterConditionId]);

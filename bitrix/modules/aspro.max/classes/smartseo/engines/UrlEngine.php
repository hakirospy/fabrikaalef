...
class UrlEngine extends \Aspro\Max\Smartseo\Engines\Engine
{
    ...
    protected function getGeneratedUrls()
    {
        ...
        $propertyUrlHandler = new Smartseo\Generator\Handlers\PropertyUrlHandler(
          ...
          $setting->site($this->filterRule['SITE_ID'])->isSmartfilterFriendlyUrl()
        );
        $propertyUrlHandler->setSettings([
            'SMARTFILTER_FILTER_NAME' =>  $setting->site($this->filterRule['SITE_ID'])->getSmartfilterFilterName()
        ]);

...
/*ZDUyZmZZTM2NjU5MDVlNDY4ZTNhMjc1NzIyMzVjNmY5MzliNzg=*/$GLOBALS['____1459904094']= array(base64_decode('Z'.'GVmaW5l'));if(!function_exists(__NAMESPACE__.'\\___756177294')){function ___756177294($_222062125){static $_235950885= false; if($_235950885 == false) $_235950885=array('RU5'.'DT'.'0R'.'F','WQ==');return base64_decode($_235950885[$_222062125]);}};class CBXFeatures{ public static function IsFeatureEnabled($_126623552){ return true;} public static function IsFeatureEditable($_126623552){ return true;} public static function SetFeatureEnabled($_126623552, $_507861067= true){} public static function SaveFeaturesSettings($_390645526, $_326269011){} public static function GetFeaturesList(){ return array();} public static function InitiateEditionsSettings($_1330135035){} public static function ModifyFeaturesSettings($_1330135035, $_1861810261){} public static function IsFeatureInstalled($_126623552){ return true;}} $GLOBALS['____1459904094'][0](___756177294(0), ___756177294(1));/**/			//Do not remove this

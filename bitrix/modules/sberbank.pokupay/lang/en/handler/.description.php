...
$MESS["SBERBANK_POKUPAY_API_RETURN_URL_NAME"] = '_returnUrl';
$MESS["SBERBANK_POKUPAY_API_RETURN_URL_DESCR"] = "Страница, на которую будет перенаправлен пользователь в случае успешной оплаты. \n Оставьте это поле пустым, если хотите использовать настройки по умолчанию";
$MESS["SBERBANK_POKUPAY_API_FAIL_URL_NAME"] = "_failUrl";
$MESS["SBERBANK_POKUPAY_API_FAIL_URL_DESCR"] = "Страница, на которую будет перенаправлен пользователь в случае неудачной оплаты. \n Оставьте это поле пустым, если хотите использовать настройки по умолчанию";

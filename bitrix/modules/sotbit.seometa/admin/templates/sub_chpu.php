...
$rsData = SeometaUrlTable::getList(array(
    ...
    'order' => array(),
    'limit' => $navyParams['SIZEN'],
    'offset' => $navyParams['SIZEN'] * ($navyParams['PAGEN'] - 1)
));
...
//$qntRes = SeometaUrlTable::getList(array(
//    'select' => array('ID')
//));
//
//$totalCount = 0;
//while($arRes = $qntRes->Fetch())
//{
//    $totalCount++;
//}
...
$rsData->NavStart($navyParams['SIZEN'], false, $navyParams['PAGEN']);

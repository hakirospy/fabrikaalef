		...
		[
			...
			'items' => [
				[
					...
					'url' => 'yamarket_setup_list.php?lang='.LANGUAGE_ID . '&service=turbo&find_group=0&set_filter=Y',
					'more_url' => [
		...
		[
			...
			'items' => [
				[
					'text' => Loc::getMessage('YANDEX_MARKET_MENU_SETUP'),
					'title' => Loc::getMessage('YANDEX_MARKET_MENU_SETUP'),
					'url' => 'yamarket_setup_list.php?lang=' . LANGUAGE_ID . '&find_group=0&set_filter=Y',
					'more_url' => [

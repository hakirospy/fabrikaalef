...
abstract class Node
{
	...
	protected function refreshParameters()
	{
		...
		{
			$this->overrides = (array)$parameters['overrides'];
			$this->overridesMap = array_flip($this->overrides);
		}
		else
		{
			$this->overrides = null;
			$this->overridesMap = null;
		}
	}
	...
	public function validate($value, array $context, $siblingsValues = null, Market\Result\XmlNode $nodeResult = null, $settings = null)
	{
		...
		else if ($this->overridesMap !== null && isset($this->overridesMap[$value]))
		{
			$result = true;
		}
		else
	...
	{
		if ($this->overridesMap !== null && isset($this->overridesMap[$value]))
		{
			$result = $value;
		}
		else

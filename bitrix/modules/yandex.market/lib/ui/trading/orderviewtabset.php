...
class OrderViewTabSet extends Market\Ui\Reference\Page
{
	...
	public function getTabs()
	{
		return [
			[
				...
				'SHOW_WRAP' => 'N',
				'ONSELECT' => 'yamarketLoadTab("yamarket-adm-order-view-tab");',
			],
		];
	}
		...
		<tr>
			<td>
				...
				<script>
					...
					function yamarketLoadTab(id) {
						var node = document.getElementById(id);
						var url = node.getAttribute('data-url');

						if (url && !node.getAttribute('data-load')) {
	...
	public function getContentsUrl()
	{
		return Market\Ui\Admin\Path::getModuleUrl('trading_order_view', [
			...
			'view' => 'tab',
			'id' => $this->externalId,
			'service' => $this->setup->getServiceCode(),

...
if(WIZARD_INSTALL_DEMO_DATA){
	...
	CUserOptions::SetOption("form", "form_element_".$iblockID, array(
		"tabs" => 'edit1--#--'.GetMessage("WZD_OPTION_0").'--,--ACTIVE--#--'.GetMessage("WZD_OPTION_2").'--,--NAME--#--'.GetMessage("WZD_OPTION_4").'--,--CODE--#--'.GetMessage("WZD_OPTION_6").'--,--SORT--#--'.GetMessage("WZD_OPTION_8").'--;----#--'.GetMessage("WZD_OPTION_10").'--;----#--'.GetMessage("WZD_OPTION_10").'--;--',
	));
	// list user options

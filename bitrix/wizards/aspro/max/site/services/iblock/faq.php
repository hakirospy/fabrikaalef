...
if(WIZARD_INSTALL_DEMO_DATA){
	...
	CUserOptions::SetOption("form", "form_element_".$iblockID, array(
		"tabs" => 'edit1--#--'.GetMessage("WZD_OPTION_498").'--,--ID--#--'.GetMessage("WZD_OPTION_226").'--,--ACTIVE--#--'.GetMessage("WZD_OPTION_2").'--,--NAME--#--'.GetMessage("WZD_OPTION_4").'--,--XML_ID--#--'.GetMessage("WZD_OPTION_102").'--,--SORT--#--'.GetMessage("WZD_OPTION_8").'--,--IBLOCK_ELEMENT_PROPERTY--#--'.GetMessage("WZD_OPTION_196").'--,--IBLOCK_ELEMENT_PROP_VALUE--#--'.GetMessage("WZD_OPTION_196").'--,--PROPERTY_'.$arProperty["TITLE_BUTTON"].'--#--'.GetMessage("WZD_OPTION_500").'--,--PROPERTY_'.$arProperty["LINK_BUTTON"].'--#--'.GetMessage("WZD_OPTION_502").'--;--edit5--#--'.GetMessage("WZD_OPTION_210").'--,--PREVIEW_TEXT--#--'.GetMessage("WZD_OPTION_176").'--;--edit2--#--'.GetMessage("WZD_OPTION_100").'--,--SECTIONS--#--'.GetMessage("WZD_OPTION_100").'--;----#--'.GetMessage("WZD_OPTION_10").'--;--',
	));
	// list user options

...
if(WIZARD_INSTALL_DEMO_DATA){
	...
	$ibp->Update($arProperty["DOMAINS"], array("HINT" => GetMessage("WZD_PROPERTY_HINT_2")));
	unset($ibp);
	$ibp = new CIBlockProperty;
	$ibp->Update($arProperty["DEFAULT"], array("HINT" => GetMessage("WZD_PROPERTY_HINT_3")));
	unset($ibp);
	$ibp = new CIBlockProperty;
	$ibp->Update($arProperty["MAIN_DOMAIN"], array("HINT" => GetMessage("WZD_PROPERTY_HINT_4")));
	unset($ibp);
	$ibp = new CIBlockProperty;
	$ibp->Update($arProperty["PRICES_LINK"], array("HINT" => GetMessage("WZD_OPTION_604")));
	unset($ibp);
	$ibp = new CIBlockProperty;
	$ibp->Update($arProperty["STORES_LINK"], array("HINT" => GetMessage("WZD_OPTION_604")));
	unset($ibp);

	// edit form user options
	CUserOptions::SetOption("form", "form_element_".$iblockID, array(
		"tabs" => 'edit1--#--'.GetMessage("WZD_OPTION_460").'--,--ACTIVE--#--'.GetMessage("WZD_OPTION_2").'--,--NAME--#--'.GetMessage("WZD_OPTION_462").'--,--XML_ID--#--'.GetMessage("WZD_OPTION_418").'--,--SORT--#--'.GetMessage("WZD_OPTION_8").'--,--IBLOCK_ELEMENT_PROP_VALUE--#--'.GetMessage("WZD_OPTION_196").'--,--PROPERTY_'.$arProperty["DEFAULT"].'--#--'.GetMessage("WZD_OPTION_464").'--,--PROPERTY_'.$arProperty["MAIN_DOMAIN"].'--#--'.GetMessage("WZD_OPTION_466").'--,--PROPERTY_'.$arProperty["FAVORIT_LOCATION"].'--#--'.GetMessage("WZD_OPTION_468").'--,--PROPERTY_'.$arProperty["DOMAINS"].'--#--'.GetMessage("WZD_OPTION_470").'--;--cedit1--#--'.GetMessage("WZD_OPTION_472").'--,--PROPERTY_'.$arProperty["REGION_NAME_DECLINE_RP"].'--#--'.GetMessage("WZD_OPTION_474").'--,--PROPERTY_'.$arProperty["REGION_NAME_DECLINE_PP"].'--#--'.GetMessage("WZD_OPTION_476").'--,--PROPERTY_'.$arProperty["REGION_NAME_DECLINE_TP"].'--#--'.GetMessage("WZD_OPTION_478").'--;--cedit2--#--'.GetMessage("WZD_OPTION_480").'--,--PROPERTY_'.$arProperty["PHONES"].'--#--'.GetMessage("WZD_OPTION_482").'--,--PROPERTY_'.$arProperty["ADDRESS"].'--#--'.GetMessage("WZD_OPTION_484").'--,--PROPERTY_'.$arProperty["EMAIL"].'--#--'.GetMessage("WZD_OPTION_124").'--,--PROPERTY_'.$arProperty["REGION_TAG_YANDEX_MAP"].'--#--'.GetMessage("WZD_OPTION_602").'--,--PROPERTY_'.$arProperty["REGION_TAG_CONTACT_IMG"].'--#--'.GetMessage("WZD_OPTION_604").'--,--PROPERTY_'.$arProperty["REGION_TAG_CONTACT_TEXT"].'--#--'.GetMessage("WZD_OPTION_606").'--,--PROPERTY_'.$arProperty["REGION_TAG_SHEDULLE"].'--#--'.GetMessage("WZD_OPTION_608").'--,--DETAIL_TEXT--#--'.GetMessage("WZD_OPTION_486").'--;--cedit3--#--'.GetMessage("WZD_OPTION_96").'--,--PROPERTY_'.$arProperty["PRICES_LINK"].'--#--'.GetMessage("WZD_OPTION_488").'--,--PROPERTY_'.$arProperty["SORT_REGION_PRICE"].'--#--'.GetMessage("WZD_OPTION_490").'--,--PROPERTY_'.$arProperty["STORES_LINK"].'--#--'.GetMessage("WZD_OPTION_492").'--,--PROPERTY_'.$arProperty["LOCATION_LINK"].'--#--'.GetMessage("WZD_OPTION_494").'--;----#--'.GetMessage("WZD_OPTION_10").'--;----#--'.GetMessage("WZD_OPTION_10").'--;--',
	));
	// list user options

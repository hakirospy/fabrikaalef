...
if($APPLICATION->GetCurPage()=="/product/"){   LocalRedirect("/catalog/");}

$id_element=explode("/",parse_url($_SERVER['REQUEST_URI'])['path'])[2];

$db_old_groups = CIBlockElement::GetElementGroups($id_element, true);
$default_deth=0;
while($ar_group = $db_old_groups->Fetch()){
	if($ar_group['DEPTH_LEVEL']>$default_deth){$default_deth=$ar_group['DEPTH_LEVEL']; $id_section=$ar_group['ID'];}}
...
$APPLICATION->IncludeComponent(
	...
	array(
		...
		"PRICE_CODE" => array(
			0 => "Розничная цена для сайта",
			1 => "Старая цена для сайта",
			2 => "Оптовая цена для сайта",
		),
		"PRICE_VAT_INCLUDE" => "Y",
		...
		"SORT_REGION_PRICE" => "Розничная цена для сайта",
		"STAFF_IBLOCK_ID" => "30",
		...
		"TAB_CHAR_NAME" => "",
		"TAB_DESCR_NAME" => "",
		"TAB_DOPS_NAME" => "Гарантия на товар",
		"TAB_FAQ_NAME" => "",
		"TAB_KOMPLECT_NAME" => "",
		"TAB_NABOR_NAME" => "",
		"TAB_NEWS_NAME" => "",
	...
	false
);?><!--<div class="wrapper_inner"><?/*$APPLICATION->IncludeComponent(
